...
def build_calendar_tools(service):
    ...
    def list_events(time_min: str | None = None, time_max: str | None = None, max_results: int = 20):
        ...
        result = calendar_service_module.list_events(
    ...
    def create_event(
        ...
        result = calendar_service_module.create_event(
    ...
    def update_event(event_id: str, updates: dict):
        ...
        """
        result = calendar_service_module.update_event(service=service, event_id=event_id, updates=updates)
        return json.dumps(result)
